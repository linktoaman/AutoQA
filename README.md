# AutoQA - Simple AI-Powered API Testing Application

A beginner-friendly, local AI API testing application built with Node.js and Ollama. Upload your Postman collection, and let AutoQA automatically generate test cases using AI and execute them.
...
AutoQA generates these test types for each API:
...
A: AutoQA has fallback test cases. It will still generate and run tests without Ollama.
...
AutoQA makes API testing simple, fast, and intelligent.
